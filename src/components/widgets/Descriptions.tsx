...
export function DescriptionsWidget() {
  ...
  .desc-label { font-size:12px; font-weight:700; text-transform:uppercase; letter-spacing:.05em; color:hsl(var(--muted-foreground, 110 10% 40%)); font-family:'Satoshi', sans-serif; }
  .desc-value { font-size:14px; font-family:'Satoshi', sans-serif; color:hsl(var(--foreground, 222 47% 11%)); }
